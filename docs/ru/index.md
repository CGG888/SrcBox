...
<div class="disclaimer">
  <strong>Отказ от ответственности:</strong> Видео, скриншоты и демо на этой странице предназначены только для демонстрации функций. <strong>Этот проект не предоставляет M3U плейлистов или данных каналов.</strong> ПО распространяется по лицензии MIT. Подробности см. в <a href="https://github.com/CGG888/SrcBox/blob/main/LICENSE.txt">LICENSE.txt</a>.
</div>
