...
<span style="color:#22c55e">✔</span> **Catchup Replay** - Template-based automatic catchup URL generation<br>
<span style="color:#22c55e">✔</span> **Timeshift** - Real-time seeking in live streams, seek within program boundaries<br>
<span style="color:#22c55e">✔</span> **Channel Management** - Groups, search, favorites, history, group sorting
...
<span style="color:#22c55e">✔</span> **Auto Source Switching** - Automatic switch when source fails
...
<span style="color:#22c55e">✔</span> **Close Mode Memory** - Remember exit/minimize to tray choice

### Remote & Sync

<span style="color:#22c55e">✔</span> **Web Remote Control** - Browser-based player control<br>
...
<span style="color:#6b7280">○</span> **Multi-Source Management** - Source health detection, auto-fallback, observability logs<br>
